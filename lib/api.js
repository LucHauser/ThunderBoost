...
export async function getAllProductByFilterParameter(param) {
    const response = await fetch(`${URL}/products?${param}`)
    if (!response.ok) {
        throw Error(response.statusText)
    }
    return await response.json()
...
export async function getAllHighlights() {
    const response = await fetch(`${URL}/highlight`)
    if (!response.ok) {
        throw Error(response.statusText)
    }
    return await response.json()
...
export async function getAllHighlightDrafts() {
    const response = await fetch(`${URL}/highlight?isDraft=true`)
}
...
export async function getHighlightById(id) {
    const response = await fetch(`${URL}/highlight/${id}`)
    if (!response.ok) {
        throw Error(response.statusText)
    }
    return await response.json()
...
export async function updateHighlight(highlight, token) {
    const response = await fetch(`${URL}/highlight/${highlight.id}`, {
        method: "PUT",
        headers: {
            "authorization": `Bearer${token}`,
            "content-type": "application/json"
...
export async function getAllCustumerQuestion() {
    const response = await fetch(URL + "/customerQuestion")
    if (!response.ok) {
        throw Error(response.statusText)
    }
    return await response.json()
...
export async function getCustomerQuestionById(id) {
    const response = await fetch(URL + `/customerQuestion/${id}`)
    if (!response.ok) {
        throw Error(response.statusText)
    }
    return await response.json()
...
export async function postCustomerQuestion(question) {
    const response = await fetch(URL + "/customerQuestion", {
        method: "POST",
        headers: {
            "content-type": "application/json"
...
export async function editCustomerQuestion(question, token) {
    const response = await fetch(`${URL}/customerQuestion/${question.id}`, {
        method: "PUT",
        headers: {
            "authorization": `Bearer${token}`,
            "content-type": "application/json"
...
export async function deleteCustomerQuestion(id, token) {
    const response = await fetch(URL + `/customerQuestion/${id}`, {
        method: "DELETE",
        headers: {
            "authorization": `Bearer ${token}`,
